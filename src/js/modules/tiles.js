...
exports.mapElements = {
  ...
  24.1: { tile: "portalred", coordinates: { x: 13, y: 4 }, tileSize: 40, drawTileFirst: false },
  24.11: { tile: "portalred", coordinates: { x: 13, y: 4 }, tileSize: 40, drawTileFirst: false },
  25: { tile: "portalblue", coordinates: { x: 13, y: 4 }, tileSize: 40, drawTileFirst: false },
  25.1: { tile: "portalblue", coordinates: { x: 13, y: 4 }, tileSize: 40, drawTileFirst: false },
  25.11: { tile: "portalblue", coordinates: { x: 13, y: 4 }, tileSize: 40, drawTileFirst: false }
};
...
exports.floor_tiles = {
  ...
  23: { tile: "yellowtile", coordinates: { x: 13, y: 5 }, tileSize: 40, img: "tiles" },
  24: { tile: "portalred", coordinates: { x: 0, y: 0 }, tileSize: 40, img: "portalred", animated: true },
  24.1: { tile: "emptyportalred", coordinates: { x: 4, y: 0 }, tileSize: 40, img: "portalred" },
  24.11: { tile: "previewportalred", coordinates: { x: 0, y: 0 }, tileSize: 40, img: "portalred", preview: true, emptyCoordinates: { x: 4, y: 0 } },
  25: { tile: "portalblue", coordinates: { x: 0, y: 0 }, tileSize: 40, img: "portalblue", animated: true },
  25.1: { tile: "emptyportalblue", coordinates: { x: 4, y: 0 }, tileSize: 40, img: "portalblue" },
  25.11: { tile: "previewportalblue", coordinates: { x: 0, y: 0 }, tileSize: 40, img: "portalblue", preview: true, emptyCoordinates: { x: 4, y: 0 } }
};
...
exports.tiles = {
  ...
  redball: { x: 14, y: 0 },
  blueball: { x: 15, y: 0 },
  ownredball: { x: 13, y: 7, dynamic: !0 },
  ownblueball: { x: 13, y: 8, dynamic: !0 },
